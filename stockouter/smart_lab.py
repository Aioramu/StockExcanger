...
def share(i, q, shares, driver) -> Dict:
    """take some shares"""
    share_stats: Dict = {}
    ...
    share_stats["net_income"] = remove_trash(from_shares(8, i, driver))
    share_stats["income_after_taxes"] = remove_trash(from_shares(9, i, driver))
